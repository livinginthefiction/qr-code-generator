                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="custom-control custom-switch mb-2">
                            ...
                            <label class="custom-control-label" for="transparent-qr"><?php echo qrcdr()->getString('background_image'); ?></label>
                        </div>
                        <div class="collapse" id="collapse-image-bg">
                            ...
                            <div class="custom-control custom-switch d-none negative-code">
                                ...
                                <label class="custom-control-label" for="negative-qr"><?php echo qrcdr()->getString('masked'); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
