...
$markerOut = filter_input(INPUT_POST, "marker_out", FILTER_SANITIZE_STRING);
...
$logo_size = filter_input(INPUT_POST, "logo_size", FILTER_SANITIZE_STRING);
...
if ($output_data) {
    ...
    $result = array(
        'token' => ($_POST['save']=="TRUE") ? date('YmdHis') : "",
        'basename' => $basename,
        'content' => $content,
        'nopdf' => $nopdf
    );
